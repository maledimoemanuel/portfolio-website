...
const FORMSPREE_ENDPOINT = process.env.REACT_APP_FORMSPREE_ID
  ...
  const handleSubmit = async (e) => {
    ...
    if (!FORMSPREE_ENDPOINT) {
      setStatus({
        submitting: false,
        success: false,
        message: 'Form is not configured. Add REACT_APP_FORMSPREE_ID to your .env file. See README or CONTACT_FORM_SETUP.md.',
      });
      return;
    }
    ...
    try {
      ...
      setStatus({
        submitting: false,
        success: false,
        message: err.message || 'Something went wrong. Please try again or email maledimoemanuel@gmail.com directly.',
      });
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-10">
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          >
            ...
            >
              {/* Status Message - only after submit */}
              {status.message && (
                <div
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-500 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-600 transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {status.submitting ? (
                  <>
                    <svg
